...
func (h *DBHandle) Get(key interface{}) (interface{}, error) {
	return h.db.Get(constructLevelKey(h.dbName, key.([]byte)))
}

// Put saves the key/value
func (h *DBHandle) Put(key interface{}, value interface{}) error {
	return h.db.Put(constructLevelKey(h.dbName, key.([]byte)), value.([]byte))
}

// Delete deletes the given key
func (h *DBHandle) Delete(key interface{}) error {
	return h.db.Delete(constructLevelKey(h.dbName, key.([]byte)))
}
